...
abstract class BaseRemoteResponse<RequestType> {
    ...
    abstract suspend fun call(): NetworkResponse<com.college.tangkis.data.source.remote.api.model.response.BaseResponse<RequestType>, com.college.tangkis.data.source.remote.api.model.response.ErrorResponse>
    fun asFlow() = value
}