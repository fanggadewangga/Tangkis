...
@Composable
fun SentConsultationSuccessScreen(navController: NavController, consultationId: String) {
    Box(
        ...
        Column(
            ...
            AppText(
                text = "Jadwal Konsultasi Terkirim",
                textAlign = TextAlign.Center,
                textStyle = Typography.headlineSmall()
            )
            Spacer(modifier = Modifier.height(16.dp))
            AppText(
                text = "Permintaan konsultasi telah diterima. Silahkan menunggu update selanjutnya pada halaman aktivitas.",
                textAlign = TextAlign.Center,
            ...
            AppText(
                ...
                modifier = Modifier.clickable {
                    navController.navigate(Screen.Home.route) {
                        popUpTo(Screen.SentConsultationSuccess.route) {
                            inclusive = true
                        }
                    }
                }
